...
stage('Loading Jenkins file') {
    jenkinsFile = fileLoader.fromGit('project-Jenkins/project', 'https://github.com/GajananHegde/Jenkins-repo', 'main', '', '')
}
    ...
    stage('Loading Jenkins file'){
      ...
      steps {
        ...
        checkout changelog: false, poll: false, scm: [$class: 'GitSCM', branches: [[name: '*/main']], 
          ...
          submoduleCfg: [], userRemoteConfigs: [[credentialsId: '', url: 'https://github.com/GajananHegde/Jenkins-repo']]]
